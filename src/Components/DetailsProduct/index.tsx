    ...
    return (
        <>
            <StyledDivContainer>
                <div>
                    ...
                    <section className="boxInfoCar">
                        <div className="infoCar">
                            <h2>
                                {convertStr(saleFounded.brand)}{" "}
                                {convertStr(saleFounded.model)}
                            </h2>
                ...
                <div className="detailsSection">
                    ...
                    <section className="detailsSeller">
                        ...
                        <h2>
                            {saleFounded.user.firstName}{" "}
                            {saleFounded.user.lastName}
                        </h2>
                        <p> {saleFounded.user.description} </p>
                        <Button
                            onClick={() =>
                                navigate(
                                    `/ProfileViewUser/${saleFounded.user.id}`
                                )
                            }
                        >
                            Ver todos anúncios
            ...
            <StyledSectionComments>
                <div>
                    <SalesComments comments={saleFounded.comments} />
                </div>
            </StyledSectionComments>
        </>
    );
